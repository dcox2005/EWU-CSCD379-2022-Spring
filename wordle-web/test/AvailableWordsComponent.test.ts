...
describe('AvailableWord', () => 
{
    ...
    {
        words = new AvailableWords();
        expect(words.availableWordCount).toBe(0);
        word = "apple";
        allWords = words.validWords(word);
        expect(words.availableWordCount).toBe(0);
    ...
    test('word a????', () =>
    {
        ...
        expect(words.availableWordCount).toBe(29);
    ...
    test('complicated ?a??h', () =>
    {
        ...
        expect(words.availableWordCount).toBe(2);
    ...
    test('find hus?y', () =>
    {
        ...
        expect(words.availableWordCount).toBe(1);
